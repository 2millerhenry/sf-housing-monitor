...
$tool = Join-Path $env:LOCALAPPDATA 'SF Housing Monitor\tools\open.ps1'
if (-not (Test-Path -LiteralPath $tool)) { throw 'SF Housing Monitor is not installed. Double-click Install first.' }
